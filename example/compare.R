...
cont_1000g_dv <- read.csv("1000G_DeepVar.cont.tsv", header=T, sep="\t")
cont_1000g_GATK <- read.csv("1000G_GATK.cont.tsv", header=T, sep="\t")
cont_gtex_GATK <- read.csv("GTeX.cont.tsv", header=T, sep="\t")

cont_1000g_dv$cohort <- "1000G_DV"
cont_1000g_GATK$cohort <- "1000G_GATK"
cont_gtex_GATK$cohort <- "GTeX"

df <- rbind(cont_1000g_dv, cont_1000g_GATK, cont_gtex_GATK)
